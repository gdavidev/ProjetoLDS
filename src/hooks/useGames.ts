...
export default function useGames(options?: UseGameOptions<Game[]>): UseQueryResult {
...
export function useGame(id: number, options?: UseGameOptions<Game>): UseQueryResult {
