...
from .views import ROMList, ROMDetail, ROMDownload, ROMCreate, ROMUpdate, ROMDelete, Register, UserAddWishlist, UserDelete, UserDetail, UserList, UserRemoveWishlist, UserUpdate, UserWishlist, RefreshToken, Login
...
urlpatterns = [
    ...
    path("register/", Register.as_view(), name="user-create"),
